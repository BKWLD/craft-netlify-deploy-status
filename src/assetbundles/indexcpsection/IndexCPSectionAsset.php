...
namespace bukwild\craftnetlifydeploystatus\assetbundles\indexcpsection;
...
class IndexCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@bukwild/craftnetlifydeploystatus/assetbundles/indexcpsection/dist";
