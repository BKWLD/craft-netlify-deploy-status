...
namespace bukwild\craftnetlifydeploystatus\widgets;

use bukwild\craftnetlifydeploystatus\CraftNetlifyDeployStatus;
use bukwild\craftnetlifydeploystatus\assetbundles\craftnetlifydeploystatuswidgetwidget\CraftNetlifyDeployStatusWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Craft Netlify Deploy Status Widget
 *
 ...
 * @since     1.0.0
 */
class CraftNetlifyDeployStatusWidget extends Widget
{
    ...
    {
        return Craft::t('craft-netlify-deploy-status', 'CraftNetlifyDeployStatusWidget');
    }
    ...
    {
        return Craft::getAlias("@bukwild/craftnetlifydeploystatus/assetbundles/craftnetlifydeploystatuswidgetwidget/dist/img/CraftNetlifyDeployStatusWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'craft-netlify-deploy-status/_components/widgets/CraftNetlifyDeployStatusWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CraftNetlifyDeployStatusWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'craft-netlify-deploy-status/_components/widgets/CraftNetlifyDeployStatusWidget_body',
            [
